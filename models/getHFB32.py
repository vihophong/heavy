...
for i in npdat:
    ...
    NN=AA-ZZ
    mass=i[9]
    Ebind = NN*8.07131806+ZZ*7.288971064-mass
    data_raw.append({"ZA": ZZ*1000+NN+ZZ,"N": NN,"Z": ZZ,"A": AA,"EL": getnamebyz(ZZ),"Ebind":Ebind,"Mth":mass,"Sn":i[6]})
# print(data_raw)
...
for i in range(len(data_raw)):
    ...
    # print("check consistency",S1n,data_raw[i]["Sn"])
    isbound = False
...
np.save("data_hfb32.npy",data_bound)
