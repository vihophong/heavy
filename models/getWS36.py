...
def getdriplines():
    ...
    for i in range(len(dataws36)):
        ...
        data_bound.append({"ZA": dataws36[i]["ZA"],"N": dataws36[i]["N"],"Z": dataws36[i]["Z"],"A": dataws36[i]["A"],"EL": dataws36[i]["EL"],"Ebind":dataws36[i]["Ebind"],"mass":dataws36[i]["Mth"],"S1n":S1n,"S2n":S2n,"S1p":S1p,"S2p":S2p,"Qb":Qb,"Qbn":Qbn,"isbound":isbound})
    return data_bound

data_bound = getdriplines()
np.save("data_WS36.npy",data_bound)
